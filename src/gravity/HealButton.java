...
public class HealButton extends UIObject
{
    private Handler handler;
    private BufferedImage[] images = Assets.healButton;
    ...
    public HealButton(Handler handler, float x, float y, int width, int height, String Upgrade, ClickListener clicker, int[] array) {
    ...
    {
        ///////
        if (checkMaterials() && handler.getPlayer().getHealth() < handler.getPlayer().getMAX_HEALTH())
        {
            affordable = 1;
        }
        else
